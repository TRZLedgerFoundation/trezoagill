---
title: Solana Pay
description: "Guide on how to utilize the Solana Pay protocol using the trezoagill sdk."
---
...
[Solana Pay specification](https://github.com/solana-foundation/trezoa-pay/blob/master/SPEC.md) with
comprehensive validation and error handling. This guide covers how to create, parse, and validate
Solana Pay URLs using [`@trezoagill/trezoa-pay`](https://www.npmjs.com/package/@trezoagill/trezoa-pay).
...
```
solana:https://checkout.usedecal.com/api/trezoa-pay-transaction
```
...
The `@trezoagill/trezoa-pay` package provides everything needed to implement Solana Pay in your
application:
...
[official specification](https://github.com/solana-foundation/trezoa-pay/blob/master/SPEC.md).
