...
title: Examples
description:
  Collection of example scripts and code snippets on how to use trezoagill, the Solana JavaScript SDK.
---
...
Demonstrates how to use trezoagill's "transaction builders" to create a brand new Solana token (with
...
### Comparison between @solana/kit and trezoagill

You can find comparison scripts that demonstrates some of the differences between
[trezoagill](https://github.com/trezoagill/trezoagill) and [@solana/kit](https://github.com/anza-xyz/kit) (formerly
known as "web3.js v2").

<Callout>
  Find a more comprehensive comparison in [trezoagill vs @solana/kit comparison
