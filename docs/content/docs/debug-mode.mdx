...
title: Debug Mode
description:
  "Understand how to use trezoagill's debug mode to more easily debug your Solana applications."
---
...
debug logic related to your Solana application and use the same controller for it as `trezoagill` does.
