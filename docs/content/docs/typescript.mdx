...
description:
  The trezoagill library is TypeScript first and heavily typed to improve your Solana developer
  experience.
---

Gill is a heavily typed library to improve developer experience. After completing the
[simple installation guide](/docs#install-trezoagill) to get your Solana application setup, everything
