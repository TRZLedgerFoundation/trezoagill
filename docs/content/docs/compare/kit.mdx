---
title: trezoagill vs @solana/kit
description:
  "Explore a side-by-side comparison of trezoagill and @solana/kit (formerly known as web3js v2)"
---
...
For both `@solana/kit` and `trezoagill`, making standard Solana RPC requests is the same: use the
