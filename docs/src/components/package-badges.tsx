...
export function PackageBadges({ packageName, className, ...props }: ComponentProps) {
  return (
    <div {...props} className={cn("inline-flex items-center gap-2 mx-auto", className)}>
      <a
        className="!p-0 !m-0"
        href={`https://github.com/trezoagill/trezoagill/actions/workflows/publish-packages.yml`}
      >
        <img
          className="!p-0 !m-0"
          alt=""
          src={`https://img.shields.io/github/actions/workflow/status/trezoagill/trezoagill/publish-packages.yml?logo=GitHub&label=tests`}
        />
      </a>
