...
import { createKeyPairSignerFromBytes, type KeyPairSigner } from "@trezoa/kit";
 ...
 * (i.e. same format as those generated by the `trezoa-keygen` command)
 *
