import { COMPUTE_BUDGET_PROGRAM_ADDRESS, ComputeBudgetInstruction } from "@trezoa-program/compute-budget";
import type { Instruction, InstructionWithData, TransactionMessage } from "@trezoa/kit";
import { isInstructionForProgram, isInstructionWithData } from "@trezoa/kit";
